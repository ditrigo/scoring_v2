...
class Post(models.Model):
    ...
    created_dt = models.DateTimeField(verbose_name='post created', 
                                      auto_now_add=True)
    updated_dt = models.DateTimeField(verbose_name='post updated', 
                                      blank=True, 
                                      null=True)
...
class PostComment(models.Model):
    ...
    status = models.CharField(max_length=20, 
                              verbose_name='status', 
                              choices=statuses) 
    created_dt = models.DateTimeField(verbose_name='created', 
                                      auto_now_add=True)
    updated_dt = models.DateTimeField(verbose_name='updated', 
                                      blank=True, 
                                      null=True)
    author = models.ForeignKey('auth.User', 
...
class Csv_Attribute(models.Model):
    ...
    report_d = models.DateField(verbose_name='report day', 
                                auto_now_add=True)
    att_001 = models.FloatField(verbose_name = 'credit', 
                                blank=True, 
                                null=True)
    att_002 = models.FloatField(verbose_name='deposit', 
                                blank=True, 
                                null=True)
    att_003 = models.FloatField(verbose_name='fine', 
                                blank=True, 
                                null=True)
...
class Counted_Att(models.Model):
    ...
    uuid = models.ForeignKey(Csv_Attribute, 
                             on_delete=models.RESTRICT, 
                             verbose_name='UUID')
    author = models.ForeignKey('auth.User', 
                               related_name='counted_atts', 
                               verbose_name='author', 
                               on_delete=models.CASCADE)
    created_dt = models.DateTimeField(verbose_name='created', 
                                      auto_now_add=True)
...
class Counted_Att_Formula(models.Model):
    ...
    uuid = models.ForeignKey(Csv_Attribute, 
                             ...
                             verbose_name='UUID')
    author = models.ForeignKey('auth.User', 
                               related_name='counted_att_formulas', 
                               verbose_name='author', 
                               on_delete=models.CASCADE)
    created_dt = models.DateTimeField(verbose_name='created', 
                                      auto_now_add=True)
    ...
    att_formula_sql = models.TextField(verbose_name='SQL formula', 
                                       blank=True, null=True)
    description = models.TextField(verbose_name='description')
    cntd_att_id = models.ForeignKey(Counted_Att, 
                                    on_delete=models.RESTRICT, 
                                    verbose_name='Counted att id')
    nested_level = models.IntegerField(verbose_name='nested level', 
                                       blank=True, 
                                       null=True)
