...
const UploadBlock = ({ uploadedFiles, setUploadedFiles }) => {
  ...
  return (
    <div
      className="border border-primary rounded d-flex justify-content-center
            align-items-center p-5 m-4 text-center"
    ...
    >
      ...
      >
        <input
          ...
          type="file"
          multiple
          style={{ position: "absolute", overflow: "hidden", opacity: 0, height: 0, width: 0 }}
        />
        <div>
          <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor"
            className="bi text-primary bi-inbox" viewBox="0 0 16 16">
            <path
