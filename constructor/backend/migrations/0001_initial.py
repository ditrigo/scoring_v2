# Generated by Django 4.2.5 on 2023-11-20 07:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('representative_phone', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('support_duration', models.IntegerField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.fieldsofpositivedecisions'),
        ),
        migrations.AddField(
            model_name='kpipositivedecisionfields',
            name='kpi',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.kpi'),
        ),
        migrations.AddField(
            model_name='kpi',
            name='negative_decision_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.negativedecision'),
        ),
        migrations.AddField(
            model_name='kpi',
            name='positive_decision_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.positivedecision'),
        ),
        migrations.AddIndex(
            model_name='innres',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.informationsourcetype'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='compliancecriteria',
            name='debt_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.debttype'),
        ),
        migrations.AddField(
            model_name='compliancecriteria',
            name='support_measure',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.supportmeasure'),
        ),
        migrations.AddField(
            model_name='client',
            name='applicant_status',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.applicantstatus'),
        ),
        migrations.AddField(
            model_name='client',
            name='compliance_criteria',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.compliancecriteria'),
        ),
        migrations.AddField(
            model_name='client',
            name='information_source',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.informationsource'),
        ),
        migrations.AddField(
            model_name='client',
            name='kpi',
        ...
        migrations.AddField(
            model_name='client',
            name='manager',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.manager'),
        ),
        migrations.AddField(
            model_name='client',
            name='prd_catalog',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.catalogprd'),
        ),
        migrations.AddField(
            model_name='client',
            name='reasons',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.reasonsforconsideration'),
        ),
        migrations.AddField(
            model_name='client',
            name='region',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.clientrepresentative'),
        ),
        migrations.AddField(
            model_name='client',
            name='stage_review',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.reviewstage'),
        ),
        migrations.AddIndex(
